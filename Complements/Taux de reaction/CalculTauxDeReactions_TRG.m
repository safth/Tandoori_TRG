...
%% ============== à partir du fondamental et des niveaux 1s vers ==============
%% ================ les niveaux 2p pour tous les Te considérés ================
%% ============================================================================
 %% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%%% DANS TeTauxDeReaction_TRG LIGNE 31
%% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%calcul le dénominateur de des taux de réaction
%##################################################################################################################
tic
